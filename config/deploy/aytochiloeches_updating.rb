...
set :user, 'chiloechesconsulupdate'
set :deploy_to, -> { "/home/#{fetch(:user)}/app" }

set :app_env, 'updating'     # Name used in rollbar/hipchat, etc
set :branch,  'consul_update' # Git branch deployed
set :instance, 'aytochiloeches_updating'   # Deploy extra files from script/deploy/<instance>
